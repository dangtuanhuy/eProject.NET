...
namespace KarnelTravel.Areas.Management.Controllers
{
    public class RestaurantsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Restaurant_Code,Restaurant_Name,Restaurant_Address,Restaurant_Status,Restaurant_Description,TouristSpot_Id")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Restaurant_Code,Restaurant_Name,Restaurant_Address,Restaurant_Status,Restaurant_Description,TouristSpot_Id")] Restaurant restaurant)
        {
            if (ModelState.IsValid)
            {
